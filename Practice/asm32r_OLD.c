...
#define BEQ(s1,s1,label)    beq(0xb000,s1,s2,label,"BEQ") 
#define BEQZ(s,label)   beq(0xb080,0,s,label,"BEQZ")
#define BGEZ(s,label)   beq(0xb0b0,s,label,"BGEZ")
#define BGTZ(s,label)   beq(0xb0d0,s,label,"BGTZ")
