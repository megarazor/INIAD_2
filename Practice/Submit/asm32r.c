...
#define BEQ(s1,s2,label)beq(0xb000,s1,s2,label,"BEQ")      
#define BEQZ(s,label)   beq(0xb080,0b0000,s,label,"BEQZ")      
#define BGEZ(s,label)   beq(0xb0b0,0b0000,s,label,"BGEZ")      
#define BGTZ(s,label)   beq(0xb0d0,0b0000,s,label,"BGTZ")      
#define BL(label)       bc(0x7e00,label,"BL")
#define BL24(label)     bc24(0xfe00,label,"BL24")
#define BLEZ(s,label)   beq(0xb0c0,0b0000,s,label,"BLEZ")      
#define BLTZ(s,label)   beq(0xb0a0,0b0000,s,label,"BLTZ")      
#define BNE(s1,s2,label)beq(0xb010,s1,s2,label,"BNE")      
#define BNEZ(s,label)   beq(0xb090,0b0000,s,label,"BNEZ")      
#define CMPI(s,imm16)   rrd(0x8040,0b0000,s,imm16,"CMPI")
#define CMPU(s1,s2)     rr(0x0050,s1,s2,"CMPU")
#define CMPUI(s,imm16)  rrd(0x8050,0b0000,s,imm16,"CMPUI")
#define DIV(d,s)        rrd(0x9000,d,s,0,"DIV")
#define DIVU(d,s)       rrd(0x9010,d,s,0,"DIVU")
#define LDPI(d,s)       rr(0x20e0,d,s,"LDPI")
#define LD24(d,imm24)   ld24(0xe000,d,imm24,"LD24")
#define LDB(d,s)        rr(0x2080,d,s,"LDB")
#define LDBR(d,s,d16)   rrd(0xa080,d,s,d16,"LDBR")
#define LDH(d,s)        rr(0x20a0,d,s,"LDH")
#define LDHR(d,s,d16)   rrd(0xa0a0,d,s,d16,"LDHR")
#define LDUB(d,s)       rr(0x4110,d,s,"LDUB")
#define LDUBR(d,s,d16)  rrd(0xa090,d,s,d16,"LDUBR")
#define LDUH(d,s)       rr(0x20b0,d,s,"LDUH")
#define LDUHR(d,s,d16)  rrd(0xa0b0,d,s,d16,"LDUHR")
...
#define SLLI(d,imm5)    ri5(0x5040, d, imm5, "SLLI")
#define SRA(d,s)        rr(0x1020,d,s,"SRA")
#define SRA3(d,s,imm16) rrd(0x90a0,d,s,imm16,"SRA3")
#define SRAI(d,imm5)    ri5(0x5020, d, imm5, "SRAI")
...
#define STBR(d,s,d16)   rrd(0xa000,d,s,d16,"STBR")
#define STH(d,s)        rr(0x2020,d,s,"STH")
#define STHR(d,s,d16)   rrd(0xa020,d,s,d16,"STHR")
