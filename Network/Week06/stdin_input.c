...
int main(int argc, char *argv[]){
    ...
    while(1){
        ...
        // Input message to be sent to the client
        while(1){
...
ERROR_FGETS:
    fprintf(stderr, "ERROR: fget(3) returns NULL: Can't read message input from stdin.\n");
    if (serv_sock >= 0)
        close(serv_sock);
    return 1;
}
